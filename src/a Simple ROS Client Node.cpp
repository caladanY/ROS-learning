...
int main(int argc, char **argv)
{
   ...
   * return true and the value in srv.response will be valid. If the call did 
   * not succeed, call() will return false and the value in srv.response will be invalid. 
   */
  if (client.call(srv))
  {
